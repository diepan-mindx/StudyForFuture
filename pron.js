...
window.onload = () => {
  document
    ...
    .addEventListener("click", () => startLesson("Ngữ Pháp Cơ Bản", 75));
  document
    .getElementById("pronBtn")
    .addEventListener("click", () => startLesson("Phát Âm Chuẩn", 30));
  document
    .getElementById("vocabBtn")
    .addEventListener("click", () =>
      startLesson("1000 Từ Vựng Thông Dụng", 10)
    );
};
